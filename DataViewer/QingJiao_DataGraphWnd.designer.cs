...
{
    partial class QingJiao_DataGraphWnd
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.m_QingJiaoXlist = new PointPairList();
            this.m_QingJiaoYlist = new PointPairList();
            ...
            //this.graphControl.AxisYTitle = "倾角传感参数";
            ...
            this.zedGraphControl1.GraphPane.YAxis.Title.Text = "倾角传感参数";
            this.zedGraphControl1.GraphPane.XAxis.Type = ZedGraph.AxisType.DateAsOrdinal;


            myQingJiaoXCurve = zedGraphControl1.GraphPane.AddCurve("X",
                m_QingJiaoXlist, Color.Red, SymbolType.None);

            myQingJiaoYCurve = zedGraphControl1.GraphPane.AddCurve("Y",
                m_QingJiaoYlist, Color.Green, SymbolType.None);
        ...
        private PointPairList m_QingJiaoXlist;
        private LineItem myQingJiaoXCurve;

        private PointPairList m_QingJiaoYlist;
        private LineItem myQingJiaoYCurve;
