...
{
    partial class ShuiZhun_DataGraphWnd 
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.m_CHENJIANGlist = new PointPairList();
            //this.m_ZHENDONGlist = new PointPairList();
            ...
            //this.graphControl.AxisYTitle = "水准传感参数";
            ...
            this.zedGraphControl1.GraphPane.YAxis.Title.Text = "水准传感参数";
            this.zedGraphControl1.GraphPane.XAxis.Type = ZedGraph.AxisType.DateAsOrdinal;


            myCHENJIANGCurve = zedGraphControl1.GraphPane.AddCurve("CJ",
                m_CHENJIANGlist, Color.Red, SymbolType.None);

            //myZHENDONGCurve = zedGraphControl1.GraphPane.AddCurve("ZD",
            //    m_ZHENDONGlist, Color.Green, SymbolType.None);
        ...
        private PointPairList m_CHENJIANGlist;
        private LineItem myCHENJIANGCurve;

        //private PointPairList m_ZHENDONGlist;
        //private LineItem myZHENDONGCurve;
