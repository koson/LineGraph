...
namespace LineGraph
{
    partial class MainFormDingZhou
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            WndHeader = new WndHeaderDingZhou();
            WndMenuListDingZhou = new WndMenuListDingZhou();
            ...
            // 
            WndMenuListDingZhou.Dock = System.Windows.Forms.DockStyle.Fill;
            this.splitContainerTop.Panel2.Controls.Add(this.WndMenuListDingZhou);
        ...
        private LineGraph.GUI.WndHeaderDingZhou WndHeader;
        private LineGraph.GUI.WndMenuListDingZhou WndMenuListDingZhou;
